...
func moduleText(_ name:String, ext:String)->String? {
    if let u = Bundle.module.url(forResource: name  , withExtension: ext), let all = try? String(contentsOf: u, encoding: .utf8) {
        return all
    }
    return nil
}
...
public class PinYin {
    ...
    public static func preLoad() {
        ...
        if let all = moduleText("pinyin", ext: "data"){
